...
ADDRESS = typing.cast(
    eth_typing.ChecksumAddress, "0x3BB898B4Bbe24f68A4e9bE46cFE72D1787FD74F4"
)


class Params(typing.NamedTuple):
    """See `struct Params` on the InflationController contract."""
...
class InflationController:
    """InflationController contract wrapper."""
    ...
    def calculate_supply_delta(
        ...
        """See `calculateSupplyDelta` on the InflationController contract."""
    ...
    def params(
        ...
        """See `params` on the InflationController contract."""
