"""InflationController contract wrapper and data structures."""
...
class InflationController:
    ...
    def calculate_supply_delta(
        ...
        """Wrapper for `calculateSupplyDelta` on the InflationController contract.
    ...
    def params(
        ...
        """Wrapper for `params` on the InflationController contract.
