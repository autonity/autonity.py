"""Autonity contract wrapper and data structures."""
...
class Autonity:
    ...
    def ActivatedValidator(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event ActivatedValidator` on the Autonity contract."""
    ...
    def AppliedUnbondingReverted(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event AppliedUnbondingReverted` on the Autonity contract."""
        return self._contract.events.AppliedUnbondingReverted

    @property
    def Approval(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event Approval` on the Autonity contract.
    ...
    def MinimumBaseFeeUpdated(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event MinimumBaseFeeUpdated` on the Autonity contract.
    ...
    def MintedStake(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event MintedStake` on the Autonity contract."""
        return self._contract.events.MintedStake

    @property
    def NewBondingRequest(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event NewBondingRequest` on the Autonity contract.
    ...
    def NewEpoch(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event NewEpoch` on the Autonity contract."""
        return self._contract.events.NewEpoch

    @property
    def NewUnbondingRequest(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event NewUnbondingRequest` on the Autonity contract.
    ...
    def PausedValidator(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event PausedValidator` on the Autonity contract."""
        return self._contract.events.PausedValidator

    @property
    def RegisteredValidator(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event RegisteredValidator` on the Autonity contract."""
    ...
    def UnbondingRejected(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event UnbondingRejected` on the Autonity contract."""
    ...
    def UnlockingScheduleFailed(self) -> typing.Type[base_contract.BaseContractEvent]:
        """Wrapper for `event UnlockingScheduleFailed` on the Autonity contract.
    ...
    def commission_rate_precision(
        ...
        """Wrapper for `COMMISSION_RATE_PRECISION` on the Autonity contract.
    ...
    def activate_validator(
        ...
        """Wrapper for `activateValidator` on the Autonity contract.
    ...
    def allowance(
        ...
        """Wrapper for `allowance` on the Autonity contract.
    ...
    def approve(
        ...
        """Wrapper for `approve` on the Autonity contract.
    ...
    def atn_total_redistributed(
        ...
        """Wrapper for `atnTotalRedistributed` on the Autonity contract.
    ...
    def balance_of(
        ...
        """Wrapper for `balanceOf` on the Autonity contract.
    ...
    def bond(
        ...
        """Wrapper for `bond` on the Autonity contract.
    ...
    def burn(
        ...
        """Wrapper for `burn` on the Autonity contract.
    ...
    def change_commission_rate(
        ...
        """Wrapper for `changeCommissionRate` on the Autonity contract.
    ...
    def complete_contract_upgrade(
        ...
        """Wrapper for `completeContractUpgrade` on the Autonity contract.
    ...
    def config(
        ...
        """Wrapper for `config` on the Autonity contract.
    ...
    def decimals(
        ...
        """Wrapper for `decimals` on the Autonity contract.
    ...
    def deployer(
        ...
        """Wrapper for `deployer` on the Autonity contract.
    ...
    def epoch_id(
        ...
        """Wrapper for `epochID` on the Autonity contract.
    ...
    def epoch_reward(
        ...
        """Wrapper for `epochReward` on the Autonity contract.
    ...
    def epoch_total_bonded_stake(
        ...
        """Wrapper for `epochTotalBondedStake` on the Autonity contract.
    ...
    def get_block_period(
        ...
        """Wrapper for `getBlockPeriod` on the Autonity contract.
    ...
    def get_committee(
        ...
        """Wrapper for `getCommittee` on the Autonity contract.
    ...
    def get_committee_enodes(
        ...
        """Wrapper for `getCommitteeEnodes` on the Autonity contract.
    ...
    def get_epoch_from_block(
        ...
        """Wrapper for `getEpochFromBlock` on the Autonity contract.
    ...
    def get_epoch_period(
        ...
        """Wrapper for `getEpochPeriod` on the Autonity contract.
    ...
    def get_last_epoch_block(
        ...
        """Wrapper for `getLastEpochBlock` on the Autonity contract.
    ...
    def get_max_committee_size(
        ...
        """Wrapper for `getMaxCommitteeSize` on the Autonity contract.
    ...
    def get_minimum_base_fee(
        ...
        """Wrapper for `getMinimumBaseFee` on the Autonity contract.
    ...
    def get_new_contract(
        ...
        """Wrapper for `getNewContract` on the Autonity contract.
    ...
    def get_operator(
        ...
        """Wrapper for `getOperator` on the Autonity contract.
    ...
    def get_oracle(
        ...
        """Wrapper for `getOracle` on the Autonity contract.
    ...
    def get_proposer(
        ...
        """Wrapper for `getProposer` on the Autonity contract.
    ...
    def get_reverting_amount(
        ...
        """Wrapper for `getRevertingAmount` on the Autonity contract.
    ...
    def get_treasury_account(
        ...
        """Wrapper for `getTreasuryAccount` on the Autonity contract.
    ...
    def get_treasury_fee(
        ...
        """Wrapper for `getTreasuryFee` on the Autonity contract.
    ...
    def get_unbonding_period(
        ...
        """Wrapper for `getUnbondingPeriod` on the Autonity contract.
    ...
    def get_unbonding_release_state(
        ...
        """Wrapper for `getUnbondingReleaseState` on the Autonity contract.
    ...
    def get_validator(
        ...
        """Wrapper for `getValidator` on the Autonity contract.
    ...
    def get_validators(
        ...
        """Wrapper for `getValidators` on the Autonity contract.
    ...
    def get_version(
        ...
        """Wrapper for `getVersion` on the Autonity contract.
    ...
    def inflation_reserve(
        ...
        """Wrapper for `inflationReserve` on the Autonity contract.
    ...
    def last_epoch_block(
        ...
        """Wrapper for `lastEpochBlock` on the Autonity contract.
    ...
    def last_epoch_time(
        ...
        """Wrapper for `lastEpochTime` on the Autonity contract.
    ...
    def max_bond_applied_gas(
        ...
        """Wrapper for `maxBondAppliedGas` on the Autonity contract.
    ...
    def max_rewards_distribution_gas(
        ...
        """Wrapper for `maxRewardsDistributionGas` on the Autonity contract.
    ...
    def max_unbond_applied_gas(
        ...
        """Wrapper for `maxUnbondAppliedGas` on the Autonity contract.
    ...
    def max_unbond_released_gas(
        ...
        """Wrapper for `maxUnbondReleasedGas` on the Autonity contract.
    ...
    def mint(
        ...
        """Wrapper for `mint` on the Autonity contract.
    ...
    def name(
        ...
        """Wrapper for `name` on the Autonity contract.
    ...
    def pause_validator(
        ...
        """Wrapper for `pauseValidator` on the Autonity contract.
    ...
    def receive_atn(
        ...
        """Wrapper for `receiveATN` on the Autonity contract.
    ...
    def register_validator(
        ...
        """Wrapper for `registerValidator` on the Autonity contract.
    ...
    def reset_contract_upgrade(
        ...
        """Wrapper for `resetContractUpgrade` on the Autonity contract.
    ...
    def set_accountability_contract(
        ...
        """Wrapper for `setAccountabilityContract` on the Autonity contract.
    ...
    def set_acu_contract(
        ...
        """Wrapper for `setAcuContract` on the Autonity contract.
    ...
    def set_committee_size(
        ...
        """Wrapper for `setCommitteeSize` on the Autonity contract.
    ...
    def set_epoch_period(
        ...
        """Wrapper for `setEpochPeriod` on the Autonity contract.
    ...
    def set_inflation_controller_contract(
        ...
        """Wrapper for `setInflationControllerContract` on the Autonity contract.
    ...
    def set_max_bond_applied_gas(
        ...
        """Wrapper for `setMaxBondAppliedGas` on the Autonity contract.
    ...
    def set_max_rewards_distribution_gas(
        ...
        """Wrapper for `setMaxRewardsDistributionGas` on the Autonity contract.
    ...
    def set_max_unbond_applied_gas(
        ...
        """Wrapper for `setMaxUnbondAppliedGas` on the Autonity contract.
    ...
    def set_max_unbond_released_gas(
        ...
        """Wrapper for `setMaxUnbondReleasedGas` on the Autonity contract.
    ...
    def set_minimum_base_fee(
        ...
        """Wrapper for `setMinimumBaseFee` on the Autonity contract.
    ...
    def set_non_stakable_vesting_contract(
        ...
        """Wrapper for `setNonStakableVestingContract` on the Autonity contract.
    ...
    def set_operator_account(
        ...
        """Wrapper for `setOperatorAccount` on the Autonity contract.
    ...
    def set_oracle_contract(
        ...
        """Wrapper for `setOracleContract` on the Autonity contract.
    ...
    def set_stabilization_contract(
        ...
        """Wrapper for `setStabilizationContract` on the Autonity contract.
    ...
    def set_staking_gas_price(
        ...
        """Wrapper for `setStakingGasPrice` on the Autonity contract.
    ...
    def set_supply_control_contract(
        ...
        """Wrapper for `setSupplyControlContract` on the Autonity contract.
    ...
    def set_treasury_account(
        ...
        """Wrapper for `setTreasuryAccount` on the Autonity contract.
    ...
    def set_treasury_fee(
        ...
        """Wrapper for `setTreasuryFee` on the Autonity contract.
    ...
    def set_unbonding_period(
        ...
        """Wrapper for `setUnbondingPeriod` on the Autonity contract.
    ...
    def set_upgrade_manager_contract(
        ...
        """Wrapper for `setUpgradeManagerContract` on the Autonity contract.
    ...
    def staking_gas_price(
        ...
        """Wrapper for `stakingGasPrice` on the Autonity contract.
    ...
    def symbol(
        ...
        """Wrapper for `symbol` on the Autonity contract.
    ...
    def total_supply(
        ...
        """Wrapper for `totalSupply` on the Autonity contract.
    ...
    def transfer(
        ...
        """Wrapper for `transfer` on the Autonity contract.
    ...
    def transfer_from(
        ...
        """Wrapper for `transferFrom` on the Autonity contract.
    ...
    def unbond(
        ...
        """Wrapper for `unbond` on the Autonity contract.
    ...
    def update_enode(
        ...
        """Wrapper for `updateEnode` on the Autonity contract.
    ...
    def update_validator_and_transfer_slashed_funds(
        ...
        """Wrapper for `updateValidatorAndTransferSlashedFunds` on the Autonity contract.
    ...
    def upgrade_contract(
        ...
        """Wrapper for `upgradeContract` on the Autonity contract.
